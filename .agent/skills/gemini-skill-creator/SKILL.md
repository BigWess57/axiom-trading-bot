...
description: Creates new skills for the Antigravity agent environment following strict structural and content standards. Use when the user asks to create a new skill or defines a new global skill.
---
